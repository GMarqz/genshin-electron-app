...
export const characters = [
    ...
    new Character("Xiao", 9, 6, 9, "Prosperty", "Grande Xiao, só sabe morrer saporra, mas gosto dele.", "./app/assets/img/ganyu.png"),
    new Character("Layla", 1, 6, 1, "Ingenuity", "Upando ela só pelo escudo mesmo, dizem que ela vai bem com Scara", "./app/assets/img/scara.png")
]
